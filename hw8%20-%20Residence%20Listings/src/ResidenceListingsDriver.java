        ...
        do {
            ...
            if (mainMenuSelection == null) {
                ...
                if (residenceType.equals(residenceTypeFindSelections[0])) {
                    ...
                    for (int i = 0; i < rl.getMaxResidences();i++){
                        Residence[] residences = rl.getResidences();
                        if (residences[i] instanceof Apartment){
                            String [] options = {"Done", "Next"};
                            JOptionPane.showOptionDialog(null, residences[i].toString(), "Residence " + i,
                    ...
                    for (int i = 0; i < rl.getMaxResidences();i++){
                        Residence[] residences = rl.getResidences();
                        if (residences[i] instanceof House){
                            String [] options = {"Done", "Next"};
                            JOptionPane.showOptionDialog(null, residences[i].toString(), "Residence " + i,
                                    JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
                        }
